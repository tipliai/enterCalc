...
| Localization | Override bundle to German | `settings.language` resolves to `Sprache`; `settings.credit.linkText` resolves to `Open-Source-Software` | `testLanguageOverrideReturnsLocalizedSettingsLabel` |
